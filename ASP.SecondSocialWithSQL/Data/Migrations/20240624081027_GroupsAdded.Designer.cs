...
namespace ASP.SecondSocialWithSQL.Data.Migrations
{
    ...
    [Migration("20240624081027_GroupsAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ASP.SecondSocialWithSQL.Entities.AppRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ASP.SecondSocialWithSQL.Entities.AppUserRole", b =>
                {
            ...
            modelBuilder.Entity("ASP.SecondSocialWithSQL.Entities.Connection", b =>
                {
            ...
            modelBuilder.Entity("ASP.SecondSocialWithSQL.Entities.Group", b =>
                {
                    b.Property<string>("Name")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("ASP.SecondSocialWithSQL.Entities.AppUserRole", b =>
                {
                    b.HasOne("ASP.SecondSocialWithSQL.Entities.AppRole", "Role")
                        .WithMany("UserRoles")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ASP.SecondSocialWithSQL.Entities.AppUser", "User")
                        .WithMany("UserRoles")
            ...
            modelBuilder.Entity("ASP.SecondSocialWithSQL.Entities.Connection", b =>
                {
                    b.HasOne("ASP.SecondSocialWithSQL.Entities.Group", null)
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("ASP.SecondSocialWithSQL.Entities.AppRole", null)
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("ASP.SecondSocialWithSQL.Entities.AppUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
