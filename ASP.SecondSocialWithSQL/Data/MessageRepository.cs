...
public class MessageRepository : IMessageRepository
{
    ...
    {
        return await _dataContext.Messages.Include(u => u.Sender)
    ...
    public async Task<PageList<MessageDto>> GetMessagesForUser(MessageParams messageParams)
    {
        ...
        query = messageParams.Container switch
        {
            ...
            _ => query.Where(u => u.SenderUsername == messageParams.Username && u.RecipientDeleted == false && u.DateRead == null)
        };
    ...
    public async Task<IEnumerable<MessageDto>> GetMessageThread(string currentUsername, string recipientname)
    {
        var messages = await _dataContext.Messages
            .Where(m => m.Recipient.UserName == currentUsername && m.RecipientDeleted == false
                        ...
                        m.Sender.UserName == recipientname && m.SenderDeleted == false)
